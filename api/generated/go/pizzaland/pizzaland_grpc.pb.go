...
const (
	...
	PizzaLand_SaveTypeDough_FullMethodName   = "/github.nhassl3.pizzaland.PizzaLand.PizzaLand/SaveTypeDough"
	PizzaLand_GetTypeDough_FullMethodName    = "/github.nhassl3.pizzaland.PizzaLand.PizzaLand/GetTypeDough"
	PizzaLand_RemoveTypeDough_FullMethodName = "/github.nhassl3.pizzaland.PizzaLand.PizzaLand/RemoveTypeDough"
)
...
type PizzaLandClient interface {
	...
	SaveTypeDough(ctx context.Context, in *SaveTypeDoughRequest, opts ...grpc.CallOption) (*SaveTypeDoughResponse, error)
	GetTypeDough(ctx context.Context, in *GetTypeDoughRequest, opts ...grpc.CallOption) (*GetTypeDoughResponse, error)
	RemoveTypeDough(ctx context.Context, in *RemoveTypeDoughRequest, opts ...grpc.CallOption) (*RemoveTypeDoughResponse, error)
}
...
func (c *pizzaLandClient) SaveTypeDough(ctx context.Context, in *SaveTypeDoughRequest, opts ...grpc.CallOption) (*SaveTypeDoughResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SaveTypeDoughResponse)
	err := c.cc.Invoke(ctx, PizzaLand_SaveTypeDough_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pizzaLandClient) GetTypeDough(ctx context.Context, in *GetTypeDoughRequest, opts ...grpc.CallOption) (*GetTypeDoughResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetTypeDoughResponse)
	err := c.cc.Invoke(ctx, PizzaLand_GetTypeDough_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pizzaLandClient) RemoveTypeDough(ctx context.Context, in *RemoveTypeDoughRequest, opts ...grpc.CallOption) (*RemoveTypeDoughResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RemoveTypeDoughResponse)
	err := c.cc.Invoke(ctx, PizzaLand_RemoveTypeDough_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PizzaLandServer interface {
	...
	SaveTypeDough(context.Context, *SaveTypeDoughRequest) (*SaveTypeDoughResponse, error)
	GetTypeDough(context.Context, *GetTypeDoughRequest) (*GetTypeDoughResponse, error)
	RemoveTypeDough(context.Context, *RemoveTypeDoughRequest) (*RemoveTypeDoughResponse, error)
...
func (UnimplementedPizzaLandServer) SaveTypeDough(context.Context, *SaveTypeDoughRequest) (*SaveTypeDoughResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SaveTypeDough not implemented")
}
func (UnimplementedPizzaLandServer) GetTypeDough(context.Context, *GetTypeDoughRequest) (*GetTypeDoughResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetTypeDough not implemented")
}
func (UnimplementedPizzaLandServer) RemoveTypeDough(context.Context, *RemoveTypeDoughRequest) (*RemoveTypeDoughResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RemoveTypeDough not implemented")
}
...
func _PizzaLand_SaveTypeDough_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SaveTypeDoughRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PizzaLandServer).SaveTypeDough(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PizzaLand_SaveTypeDough_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PizzaLandServer).SaveTypeDough(ctx, req.(*SaveTypeDoughRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PizzaLand_GetTypeDough_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetTypeDoughRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PizzaLandServer).GetTypeDough(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PizzaLand_GetTypeDough_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PizzaLandServer).GetTypeDough(ctx, req.(*GetTypeDoughRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _PizzaLand_RemoveTypeDough_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RemoveTypeDoughRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PizzaLandServer).RemoveTypeDough(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PizzaLand_RemoveTypeDough_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PizzaLandServer).RemoveTypeDough(ctx, req.(*RemoveTypeDoughRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PizzaLand_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SaveTypeDough",
			Handler:    _PizzaLand_SaveTypeDough_Handler,
		},
		{
			MethodName: "GetTypeDough",
			Handler:    _PizzaLand_GetTypeDough_Handler,
		},
		{
			MethodName: "RemoveTypeDough",
			Handler:    _PizzaLand_RemoveTypeDough_Handler,
		},
	},
