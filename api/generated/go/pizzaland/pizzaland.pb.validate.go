...
func (m *UpdateRequest) validate(all bool) error {
	...
	for idx, item := range m.GetSizes() {
		...
		if val := item; val < 26 || val > 40 {
			err := UpdateRequestValidationError{
				field:  fmt.Sprintf("Sizes[%v]", idx),
				reason: "value must be inside range [26, 40]",
			}
			if !all {
				return err
			}
	...
	if m.Rating != nil {
		...
		if wrapper := m.GetRating(); wrapper != nil {

			if val := wrapper.GetValue(); val < 0 || val > 10 {
				err := UpdateRequestValidationError{
					field:  "Rating",
...
// Validate checks the field values on SaveTypeDoughRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SaveTypeDoughRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SaveTypeDoughRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SaveTypeDoughRequestMultiError, or nil if none found.
func (m *SaveTypeDoughRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SaveTypeDoughRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if l := utf8.RuneCountInString(m.GetName()); l < 3 || l > 32 {
		err := SaveTypeDoughRequestValidationError{
			field:  "Name",
	...
	if len(errors) > 0 {
		return SaveTypeDoughRequestMultiError(errors)
	}

	return nil
}

// SaveTypeDoughRequestMultiError is an error wrapping multiple validation
// errors returned by SaveTypeDoughRequest.ValidateAll() if the designated
// constraints aren't met.
type SaveTypeDoughRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SaveTypeDoughRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SaveTypeDoughRequestMultiError) AllErrors() []error { return m }

// SaveTypeDoughRequestValidationError is the validation error returned by
// SaveTypeDoughRequest.Validate if the designated constraints aren't met.
type SaveTypeDoughRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SaveTypeDoughRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SaveTypeDoughRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SaveTypeDoughRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SaveTypeDoughRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SaveTypeDoughRequestValidationError) ErrorName() string {
	return "SaveTypeDoughRequestValidationError"
}

// Error satisfies the builtin error interface
func (e SaveTypeDoughRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSaveTypeDoughRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SaveTypeDoughRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SaveTypeDoughRequestValidationError{}

// Validate checks the field values on SaveTypeDoughResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SaveTypeDoughResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SaveTypeDoughResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SaveTypeDoughResponseMultiError, or nil if none found.
func (m *SaveTypeDoughResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *SaveTypeDoughResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SaveTypeDoughResponseMultiError(errors)
	}

	return nil
}

// SaveTypeDoughResponseMultiError is an error wrapping multiple validation
// errors returned by SaveTypeDoughResponse.ValidateAll() if the designated
// constraints aren't met.
type SaveTypeDoughResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SaveTypeDoughResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SaveTypeDoughResponseMultiError) AllErrors() []error { return m }

// SaveTypeDoughResponseValidationError is the validation error returned by
// SaveTypeDoughResponse.Validate if the designated constraints aren't met.
type SaveTypeDoughResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SaveTypeDoughResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SaveTypeDoughResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SaveTypeDoughResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SaveTypeDoughResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SaveTypeDoughResponseValidationError) ErrorName() string {
	return "SaveTypeDoughResponseValidationError"
}

// Error satisfies the builtin error interface
func (e SaveTypeDoughResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSaveTypeDoughResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SaveTypeDoughResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SaveTypeDoughResponseValidationError{}

// Validate checks the field values on GetTypeDoughRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetTypeDoughRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetTypeDoughRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTypeDoughRequestMultiError, or nil if none found.
func (m *GetTypeDoughRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTypeDoughRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetId() <= 0 {
		err := GetTypeDoughRequestValidationError{
			field:  "Id",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return GetTypeDoughRequestMultiError(errors)
	}

	return nil
}

// GetTypeDoughRequestMultiError is an error wrapping multiple validation
// errors returned by GetTypeDoughRequest.ValidateAll() if the designated
// constraints aren't met.
type GetTypeDoughRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTypeDoughRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTypeDoughRequestMultiError) AllErrors() []error { return m }

// GetTypeDoughRequestValidationError is the validation error returned by
// GetTypeDoughRequest.Validate if the designated constraints aren't met.
type GetTypeDoughRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetTypeDoughRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTypeDoughRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTypeDoughRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTypeDoughRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTypeDoughRequestValidationError) ErrorName() string {
	return "GetTypeDoughRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetTypeDoughRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTypeDoughRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTypeDoughRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTypeDoughRequestValidationError{}

// Validate checks the field values on GetTypeDoughResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetTypeDoughResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetTypeDoughResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetTypeDoughResponseMultiError, or nil if none found.
func (m *GetTypeDoughResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *GetTypeDoughResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return GetTypeDoughResponseMultiError(errors)
	}

	return nil
}

// GetTypeDoughResponseMultiError is an error wrapping multiple validation
// errors returned by GetTypeDoughResponse.ValidateAll() if the designated
// constraints aren't met.
type GetTypeDoughResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetTypeDoughResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetTypeDoughResponseMultiError) AllErrors() []error { return m }

// GetTypeDoughResponseValidationError is the validation error returned by
// GetTypeDoughResponse.Validate if the designated constraints aren't met.
type GetTypeDoughResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetTypeDoughResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetTypeDoughResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetTypeDoughResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetTypeDoughResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetTypeDoughResponseValidationError) ErrorName() string {
	return "GetTypeDoughResponseValidationError"
}

// Error satisfies the builtin error interface
func (e GetTypeDoughResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetTypeDoughResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetTypeDoughResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetTypeDoughResponseValidationError{}

// Validate checks the field values on RemoveTypeDoughRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RemoveTypeDoughRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RemoveTypeDoughRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RemoveTypeDoughRequestMultiError, or nil if none found.
func (m *RemoveTypeDoughRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *RemoveTypeDoughRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetId() <= 0 {
		err := RemoveTypeDoughRequestValidationError{
			field:  "Id",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return RemoveTypeDoughRequestMultiError(errors)
	}

	return nil
}

// RemoveTypeDoughRequestMultiError is an error wrapping multiple validation
// errors returned by RemoveTypeDoughRequest.ValidateAll() if the designated
// constraints aren't met.
type RemoveTypeDoughRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RemoveTypeDoughRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RemoveTypeDoughRequestMultiError) AllErrors() []error { return m }

// RemoveTypeDoughRequestValidationError is the validation error returned by
// RemoveTypeDoughRequest.Validate if the designated constraints aren't met.
type RemoveTypeDoughRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RemoveTypeDoughRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RemoveTypeDoughRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RemoveTypeDoughRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RemoveTypeDoughRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RemoveTypeDoughRequestValidationError) ErrorName() string {
	return "RemoveTypeDoughRequestValidationError"
}

// Error satisfies the builtin error interface
func (e RemoveTypeDoughRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRemoveTypeDoughRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RemoveTypeDoughRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RemoveTypeDoughRequestValidationError{}

// Validate checks the field values on RemoveTypeDoughResponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *RemoveTypeDoughResponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on RemoveTypeDoughResponse with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// RemoveTypeDoughResponseMultiError, or nil if none found.
func (m *RemoveTypeDoughResponse) ValidateAll() error {
	return m.validate(true)
}

func (m *RemoveTypeDoughResponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return RemoveTypeDoughResponseMultiError(errors)
	}

	return nil
}

// RemoveTypeDoughResponseMultiError is an error wrapping multiple validation
// errors returned by RemoveTypeDoughResponse.ValidateAll() if the designated
// constraints aren't met.
type RemoveTypeDoughResponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m RemoveTypeDoughResponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m RemoveTypeDoughResponseMultiError) AllErrors() []error { return m }

// RemoveTypeDoughResponseValidationError is the validation error returned by
// RemoveTypeDoughResponse.Validate if the designated constraints aren't met.
type RemoveTypeDoughResponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e RemoveTypeDoughResponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e RemoveTypeDoughResponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e RemoveTypeDoughResponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e RemoveTypeDoughResponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e RemoveTypeDoughResponseValidationError) ErrorName() string {
	return "RemoveTypeDoughResponseValidationError"
}

// Error satisfies the builtin error interface
func (e RemoveTypeDoughResponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sRemoveTypeDoughResponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = RemoveTypeDoughResponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = RemoveTypeDoughResponseValidationError{}
